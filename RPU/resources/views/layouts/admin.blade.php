...
.card-text {
  ...
  <body>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
      ...
      <symbol id="mony" viewBox="0 0 16 16">
    ...
    <main class="d-flex flex-nowrap">
      <div id="sidebarId" class="sidebar position-relative d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary ">
        <div class="d-flex align-items-center mb-0 me-md-auto link-body-emphasis text-decoration-none">
          <img src="{{ asset('images/logo-removebg-preview2.png') }}" class="doera" width="45px" onclick="toggleSidebar1()" >
          <span class="fs-4 sidebar-text ms-2">RPU</span>
        </div>
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          <li class="nav-item">
            <a href="{{route('dashboard')}}" class=" nav-link link-body-emphasis" aria-current="page">
          ...
          <li class="nav-item">
            <a href="{{route('dashmony')}}" class="  nav-link link-body-emphasis">
              <svg class="bi pe-none me-2" width="16" height="16">
                <use xlink:href="#mony" />
              </svg>
              <span class="sidebar-text"> Money management</span>
            </a>
          </li>
          <hr style="margin: 5px 15px 5px 5px ; ">

          <li class="nav-item">
            <a href="{{route('dashemp')}}" class="  nav-link link-body-emphasis">
              <svg class="bi pe-none me-2" width="16" height="16">
          ...
          <hr style="margin: 5px 15px 5px 5px ; ">
          <li class="nav-item">
            <a href="{{route('rabat')}}" class="nav-link link-body-emphasis">
              <svg class="bi pe-none me-2" width="16" height="16">
                <use xlink:href="#table" />
              </svg>
              <span class="sidebar-text">University management</span>
            </a>
          </li>
          <hr style="margin: 5px 15px 5px 5px ; ">
        ...
        <div class="dropdown">
          <a href="#" class="d-flex align-items-center link-body-emphasis text-decoration-none dropdown-toggle"
            ...
            <img src="{{ asset('images/logo-removebg-preview2.png') }}" alt="" width="32" height="32" class="rounded-circle me-2">
